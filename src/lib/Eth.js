...
export function getInstance(tokenAddress){
...
export function tokenBalance(tokenAddress,address) {
  let instance = getInstance(tokenAddress);
  return instance.methods.balanceOf(address).call()
}

export function tokenTransfer(tokenAddress,from, address, amount) {
  let instance = getInstance(tokenAddress);
  return instance.methods.transfer(address, amount).send({from})
}
